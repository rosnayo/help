  ...
  return (
    <>
      ...
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h1 className="text-xl text-gray-900 font-semibold">Profile Details</h1>
      ...
      {/* Change password */}
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h1 className="text-xl text-gray-900 font-semibold">Usuario y contraseña</h1>
        <hr className="my-8 border-gray-500/30" />
        <form className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center gap-y-4 justify-between">
            <div>
              <h5 className="text-gray-900 text-xl mb-1">Correo electrónico</h5>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-y-4 justify-between">
            <div>
              <h5 className="text-gray-900 text-xl mb-1">Contraseña</h5>
      ...
      {/* Connected accounts */}
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h1 className="text-xl text-gray-900">Conectar con cuentas</h1>
        <hr className="my-8 border-gray-500/30" />
        ...
        <form className="mb-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="flex flex-col gap-y-1">
                <h5 className="text-gray-500">Google</h5>
                <p className="text-gray-500 text-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              />
              <div className="flex flex-col gap-y-1">
                <h5 className="text-gray-500">GitHub</h5>
                <p className="text-gray-500 text-sm">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              />
              <div className="flex flex-col gap-y-1">
                <h5 className="text-gray-500">Slack</h5>
                <p className="text-gray-500 text-sm">
      ...
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        ...
        <form className="mb-8">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-y-1">
              <label htmlFor="id1" className="text-gray-500">
                Successful Payments
              </label>
              <p className="text-gray-500 text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-y-1">
              <label htmlFor="id2" className="text-gray-500">
                Payouts
              </label>
              <p className="text-gray-500 text-sm">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-y-1">
              <label htmlFor="id3" className="text-gray-500">
      ...
      {/* Inactive account */}
      <div className="bg-secondary-100 p-8 rounded-xl mb-8">
        <h1 className="text-xl text-gray-500">Desactivar cuenta</h1>
        <hr className="my-8 border-gray-500/30" />
