...
import {getUserProfile, getPerfilByUserId} from '../../services/Usuario.services';
...
export const Home = () => {
  ...
  getUserProfile().then((data) => {
    if (data) {
      ...
      setEmail(data.email)
      //console.log("yyyy" + data.user)
      getPerfilByUserId(data.user).then((data)=>{
        setId_empresa(data.id_empresa);
        setRazon_social(data.razon_social);
        setTipo_usuario(data.tipo_usuario);
      })
    }
  });
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-10">
        <h1 className="text-4xl text-gray-500">Good morning, Rafael</h1>
      ...
      <div>
        <h1 className="text-2xl text-gray-500 my-10">Tickets más recientes</h1>
      </div>
