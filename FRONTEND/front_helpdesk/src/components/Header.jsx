...
const Header = () => {
  return (
    <header className="h-[7vh] md:h-[10vh] border-b bg-secondary-100 border-gray-200 p-8 flex items-center justify-end">
      <nav className="flex items-center gap-2">
        ...
        >
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/"
              className="text-gray-300 flex flex-1 items-center gap-4 py-2 px-4 hover:bg-secondary-200 transition-colors rounded-lg"
            >
              <img
              ...
              <div className="text-sm flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <span className="text-gray-700">Jorge Luis Trejo</span>{" "}
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="text-sm flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <span className="text-gray-700">Nuevo like</span>{" "}
                  <span className="text-[8px]">21/10/2022</span>
                </div>
                <p className="text-gray-500 text-xs">
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            ...
            >
              ...
              <div className="text-sm flex flex-col">
                <div className="flex items-center justify-between gap-4">
                  <span className="text-gray-700">Nuevo comentario</span>{" "}
                  <span className="text-[8px]">21/10/2022</span>
                </div>
                <p className="text-gray-500 text-xs">
        ...
        >
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/perfil"
              className="rounded-lg transition-colors text-gray-300 hover:bg-secondary-200 flex items-center gap-x-4 py-2 px-6 flex-1"
            >
              <img
                src="https://img.freepik.com/foto-gratis/feliz-optimista-guapo-gerente-ventas-latina-apuntando-lado-mirando-camara_1262-12679.jpg"
                className="w-8 h-8 object-cover rounded-full"
              ...
              <div className="flex flex-col text-sm">
                <span className="text-sm text-gray-400">Jorge Luis Trejo</span>
          ...
          <MenuItem className="p-0 hover:bg-transparent">
            <Link
              to="/configuracion"
              className="rounded-lg transition-colors text-gray-400 hover:bg-secondary-200 flex items-center gap-x-4 py-2 px-6 flex-1"
            >
