    ...
    <div className="bg-gray-200 p-8 rounded-xl">
      <div className="flex items-center justify-between mb-4">
        ...
        <div>
          <Menu
            menuButton={
              <MenuButton className="flex items-center gap-x-2 hover:bg-gray-400 p-2 rounded-lg transition-colors">
                <RiMore2Fill />
              </MenuButton>
            }
            align="end"
            arrow
            arrowClassName="bg-gray-500"
            transition
            menuClassName="bg-gray-500 p-4"
          >
            <MenuItem className="p-0 hover:bg-transparent">
              <Link
                to="/perfil"
                className="rounded-lg transition-colors text-white hover:bg-gray-400 flex items-center gap-x-4 p-2 flex-1"
              >
                Dashboard tickets
              </Link>
            </MenuItem>
      ...
      {/* Number of tickets */}
      <div>
        <h1 className="text-4xl text-gray-500 font-bold mb-4">{totalTickets}</h1>
